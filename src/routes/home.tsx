    ...
    <div className="lg:max-w-6xl lg:m-auto space-y-8 pb-20 m-4">
      ...
      <div className="flex flex-col lg:flex-row mt-6 lg:mt-20">
        <div className="flex flex-col space-y-4">
          ...
          <ul className="list-disc list-outside space-y-2 pl-8 lg:pl-4 mr-4">
            <li>
              <p>
                A place where you can make things. We call it a hackerspace. We
                are a grassroots co-op of volunteers— No staff.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <span className="font-bold">Hosting free public hours</span>
                <br />
        ...
        <img
          src="https://farm9.staticflickr.com/8086/27934144103_d8e7d2d078_b.jpg"
          className="max-w-2xl"
        />
      </div>
      ...
      <div className="flex flex-col lg:flex-row justify-between space-y-6 lg:space-y-0">
        ...
        <div className="flex flex-col space-y-4 content-between">
          <div className="flex flex-row items-center space-x-4">
            ...
            <a
              href="https://groups.google.com/forum/?fromgroups#!forum/heatsynclabs"
              className="text-3xl font-bold link underline"
            >
              Discussion Group
            </a>
          </div>
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-6 space-y-6 lg:space-y-0">
        <div className="flex-1 flex flex-col space-y-4">
          ...
          <p>
            HeatSync Labs is a community-driven 501(c)3 non-profit shop and
            workspace where engineers, artists, students, and hobbyists come to
            make prototypes, art, and other creative projects.
          </p>
          <p>
            It is a workshop for mad scientists, artists and anyone creating or
            making! We make tools, resources, and skills available to you.
          </p>
          <button
            onClick={() => {
        ...
        <div className="flex-1 flex flex-col space-y-4">
          ...
          <p>
            You don't need to be a member to come and make stuff, but we are
            member-supported and member-driven so your support is appreciated!
            We encourage you to bring your projects during public hours so you
            get a feel for the place first.
          </p>
          <p>
            To learn more about how we work behind the scenes, check out the{" "}
            <a
